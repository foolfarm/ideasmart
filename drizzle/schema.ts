...
export const subscribers = mysqlTable("subscribers", {
  ...
  newsletter: mysqlEnum("newsletter", ["ai4business", "itsmusic", "startup", "news", "motori", "tennis", "basket", "both"]).default("ai4business").notNull(),
...
export const newsletterSends = mysqlTable("newsletter_sends", {
  ...
  section: mysqlEnum("section", ["ai4business", "itsmusic", "startup", "finance", "health", "sport", "luxury", "news", "motori", "tennis", "basket"]).default("ai4business").notNull(),
...
export const newsItems = mysqlTable("news_items", {
  ...
  section: mysqlEnum("section", ["ai", "music", "startup", "finance", "health", "sport", "luxury", "news", "motori", "tennis", "basket"]).default("ai").notNull(),
...
export const sourceReports = mysqlTable("source_reports", {
  id: int("id").autoincrement().primaryKey(),
  // Sezione: 'ai', 'music' o 'startup'
  section: mysqlEnum("section", ["ai", "music", "startup", "finance", "health", "sport", "luxury", "news", "motori", "tennis", "basket"]).notNull(),
  // Tipo articolo
  articleType: mysqlEnum("articleType", ["news", "editorial", "startup", "reportage", "analysis"]).notNull(),
  articleId: int("articleId").notNull(),
