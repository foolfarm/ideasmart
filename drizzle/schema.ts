...
export const linkedinPosts = mysqlTable("linkedin_posts", {
  ...
  slot: mysqlEnum("slot", ["morning", "editorial", "ai-research-morning", "dealroom-morning", "research", "research-afternoon", "startup-afternoon", "startup-evening", "afternoon", "evening", "dealroom", "ai-tool-radar", "en-evening-news", "en-ai-research", "en-research", "en-research-late", "weekend-digest", "thought-leadership"]).default("morning").notNull(),
...
export const personaggi = mysqlTable("personaggi", {
  id: int("id").primaryKey().autoincrement(),
  name: varchar("name", { length: 255 }).notNull(),
  slug: varchar("slug", { length: 255 }).notNull().unique(),
  role: varchar("role", { length: 255 }),
  company: varchar("company", { length: 255 }),
  country: varchar("country", { length: 10 }).default("IT").notNull(),
  bio: mediumtext("bio"),
  fullBio: mediumtext("full_bio"),
  imageUrl: varchar("image_url", { length: 1024 }),
  coverImageUrl: varchar("cover_image_url", { length: 1024 }),
  category: mysqlEnum("personaggio_category", ["founder", "investor", "executive", "researcher", "journalist", "other"]).default("founder").notNull(),
  tags: json("tags").$type<string[]>(),
  fundingRaised: varchar("funding_raised", { length: 128 }),
  exits: int("exits").default(0),
  companiesCount: int("companies_count").default(1),
  linkedinUrl: varchar("linkedin_url", { length: 512 }),
  twitterUrl: varchar("twitter_url", { length: 512 }),
  websiteUrl: varchar("website_url", { length: 512 }),
  quote: mediumtext("quote"),
  quoteSource: varchar("quote_source", { length: 255 }),
  featured: boolean("featured").default(false),
  isItalian: boolean("is_italian").default(true),
  viewCount: int("view_count").default(0),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().onUpdateNow().notNull(),
}, (t) => ({
  slugIdx: uniqueIndex("idx_personaggi_slug").on(t.slug),
  categoryIdx: index("idx_personaggi_category").on(t.category),
  countryIdx: index("idx_personaggi_country").on(t.country),
  featuredIdx: index("idx_personaggi_featured").on(t.featured),
  italianIdx: index("idx_personaggi_italian").on(t.isItalian),
}));

export type Personaggio = typeof personaggi.$inferSelect;
export type InsertPersonaggio = typeof personaggi.$inferInsert;
