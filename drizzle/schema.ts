...
export const linkedinPosts = mysqlTable("linkedin_posts", {
  ...
  slot: mysqlEnum("slot", ["morning", "ai-research-morning", "research", "research-afternoon", "startup-afternoon", "afternoon", "evening", "dealroom", "ai-tool-radar"]).default("morning").notNull(),
