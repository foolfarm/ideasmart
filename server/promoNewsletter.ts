        ...
        <tr>
          <td colspan="2" style="padding-top:16px;border-top:1px solid #333;margin-top:16px;">
            <p style="margin:8px 0 0;font-family:'Helvetica Neue',Arial,sans-serif;font-size:11px;color:#555;line-height:1.6;">
              ...
              © ${new Date().getFullYear()} <a href="https://aidagpt.com" target="_blank" rel="noopener noreferrer" style="color:#666;text-decoration:none;">Aida Srl</a> — Italia · <a href="https://proofpress.ai/chi-siamo" style="color:#666;text-decoration:underline;">Chi Siamo</a>
            </p>
          </td>
        </tr>
      </table>
