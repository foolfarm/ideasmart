...
export const bannersRouter = router({
  ...
  if (!db) throw new TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "DB non disponibile" });
    ...
    const leftBanners: BannerSlim[] = activeBanners
      .filter((b: Banner) => b.slot === "left" || b.slot === "both" || b.slot === "both_sidebar")
    ...
    const rightBanners: BannerSlim[] = activeBanners
      .filter((b: Banner) => b.slot === "right" || b.slot === "both" || b.slot === "both_sidebar")
      .map((b: Banner) => ({ id: b.id, name: b.name, imageUrl: b.imageUrl, clickUrl: b.clickUrl, weight: b.weight }));

     const sidebarBanners: BannerSlim[] = activeBanners
      .filter((b: Banner) => b.slot === "sidebar" || b.slot === "both_sidebar")
      .map((b: Banner) => ({ id: b.id, name: b.name, imageUrl: b.imageUrl, clickUrl: b.clickUrl, weight: b.weight }));
  ...
  create: adminProcedure
    .input(z.object({
      ...
      slot: z.enum(["left", "right", "both", "sidebar", "horizontal", "both_sidebar"]).default("both"),
  ...
  update: adminProcedure
    .input(z.object({
      ...
      slot: z.enum(["left", "right", "both", "sidebar", "horizontal", "both_sidebar"]).optional(),
