...
const BuongiornoNewsletter = lazy(() => import("./pages/BuongiornoNewsletter"));
  ...
  return (
    <Suspense fallback={<PageSkeleton />}>
      <Switch>
        ...
        <Route path="/admin/newsletter" component={NewsletterHub} />
        ...
        <Route path="/buongiorno" component={BuongiornoNewsletter} />
