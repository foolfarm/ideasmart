 ...
 * Palette: bianco carta (#faf8f3), inchiostro (#1a1a2e), accento blu sondaggi (#2980b9).
 */
          ...
          <div className="mt-4">
            ...
            <div className="py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-4 flex-wrap justify-center sm:justify-end">
                ...
                <Link href="/cybersecurity"><span className="text-xs hover:underline cursor-pointer" style={{ color: "#27ae60", fontFamily: "'Space Mono', monospace" }}>Cybersecurity</span></Link>
