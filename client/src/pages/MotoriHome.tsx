/**
 * IDEASMART — Motori
 * Palette: bianco carta (#faf8f3), inchiostro (#1a1a2e), accento arancione motori (#e67e22).
 */
          ...
          <div className="mt-4">
            ...
            <div className="py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-4 flex-wrap justify-center sm:justify-end">
                ...
                <Link href="/news"><span className="text-xs hover:underline cursor-pointer" style={{ color: "#c0392b", fontFamily: "'Space Mono', monospace" }}>News</span></Link>
                <Link href="/tennis"><span className="text-xs hover:underline cursor-pointer" style={{ color: "#27ae60", fontFamily: "'Space Mono', monospace" }}>Tennis</span></Link>
                <Link href="/basket"><span className="text-xs hover:underline cursor-pointer" style={{ color: "#8e44ad", fontFamily: "'Space Mono', monospace" }}>Basket</span></Link>
