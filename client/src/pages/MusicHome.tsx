...
export default function MusicHome() {
  ...
  return (
    <>
      <SEOHead
        title="ITsMusic — IDEASMART"
        description="Notizie aggiornate ogni giorno sul mondo della musica italiana e internazionale. Editoriale, analisi e artista del giorno."
        canonical="https://ideasmart.ai/music"
      ...
      <div className="min-h-screen" style={{ background: "#faf8f3", color: INK }}>
        ...
        <header className="max-w-6xl mx-auto px-4 pt-6 pb-0">
          ...
          <nav className="flex items-center justify-center gap-0 py-2">
            {["Notizie", "Editoriale", "Artista del Giorno", "Reportage", "Analisi"].map((label, i) => (
              <span key={label}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-0 py-4">
                ...
                <div className="pl-0 lg:pl-6 mt-4 lg:mt-0">
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      { label: "Genere", value: artistData.category },
                      { label: "Paese", value: artistData.country || "Italia" },
                      { label: "Attivo dal", value: artistData.foundedYear || "N/D" },
                      { label: "Label", value: artistData.funding || "Indipendente" },
                    ].map(({ label, value }) => (
