 ...
 * Palette: bianco carta (#faf8f3), inchiostro (#1a1a2e), accento verde finanza (#7c3aed).
 */
        ...
        <main className="max-w-6xl mx-auto px-4 pb-16">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  {editorial.keyTrend && (
                    <div className="mt-3 pl-3 border-l-2 border-[#7c3aed]">
          ...
          <div className="mt-10">
            ...
            <div className="py-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <NewsletterSubscribeForm defaultChannel="luxury" accentColor="#b45309" />
              </div>
            </div>
          </div>
