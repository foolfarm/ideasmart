    ...
    return (
      <div className="min-h-screen bg-[#ffffff] flex items-center justify-center">
        <div className="text-center">
          <p className="font-mono text-sm text-[#1a1a1a]/60 tracking-widest uppercase mb-4">Contenuto non trovato</p>
  ...
  return (
    ...
    <div className="min-h-screen bg-[#ffffff]" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-[#1a1a1a] leading-tight mb-3" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', serif" }}>
          {spotlight.name}
        </h1>

        <p className="text-xl text-[#1a1a1a]/70 italic mb-6" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', serif" }}>{spotlight.tagline}</p>

        {/* Firma autore */}
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-[#1a1a1a]/20">
        ...
        {spotlight.whyToday && (
          <blockquote className="my-8 border-l-4 pl-6 py-2" style={{ borderColor: cfg.color }}>
            ...
            <p className="text-lg italic text-[#1a1a1a]/80 leading-relaxed" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', serif" }}>{spotlight.whyToday}</p>
          </blockquote>
        )}

        {/* AI Score */}
        {(spotlight.aiScore ?? 0) > 0 && (
          <div className="mb-8 p-4 border border-[#1a1a1a]/10 bg-white flex items-center gap-4">
            <div className="text-center">
              <p className="text-3xl font-bold" style={{ color: cfg.color, fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', serif" }}>{spotlight.aiScore ?? 0}/100</p>
              <p className="font-mono text-xs text-[#1a1a1a]/60 tracking-widest uppercase mt-1">AI Innovation Score</p>
            </div>
            <div className="flex-1 h-2 bg-[#1a1a1a]/10 rounded-full overflow-hidden">
        ...
        {/* Links */}
        <div className="mt-8 pt-6 border-t border-[#1a1a1a]/20 flex flex-wrap gap-4">
