/**
 * IDEASMART — Tennis
 * Palette: bianco carta (#faf8f3), inchiostro (#1a1a2e), accento verde tennis (#27ae60).
 */
          ...
          <div className="mt-4">
            ...
            <div className="py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-4 flex-wrap justify-center sm:justify-end">
                ...
                <Link href="/motori"><span className="text-xs hover:underline cursor-pointer" style={{ color: "#e67e22", fontFamily: "'Space Mono', monospace" }}>Motori</span></Link>
