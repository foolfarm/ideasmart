      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px;">
        <tr>
          ...
          <td style="padding:0 0 0 16px;">
            ...
            <p style="margin:0;font-family:${F_SANS};font-size:14px;color:#374151;line-height:1.6;">
              Il motore FRIO instrada l'<strong>85% dei task su modelli open-source locali</strong>, riservando solo il 15% più complesso alle API commerciali. Il costo di inferenza scende da <strong>$15 a $2 per milione di token (-87%)</strong>. Più usi Fasteer, meno paghi: il Super RAG memorizza le correzioni e sposta progressivamente il carico sui modelli gratuiti.
            </p>
          </td>
        </tr>
      </table>
